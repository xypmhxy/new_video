...
final class VideoPlayer {
    ...
    VideoPlayer(
        ...
        MediaSource mediaSource = buildMediaSource(videoUri, dataSourceFactory, formatHint);
        if (audioDataSource != null) {
            Uri audioUri = Uri.parse(audioDataSource);
            MediaSource audioSource = buildMediaSource(audioUri, dataSourceFactory, formatHint);
            mediaSource = new MergingMediaSource(true, true, mediaSource, audioSource);
        }
