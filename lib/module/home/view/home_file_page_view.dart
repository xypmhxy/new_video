...
class HomeFilePageView extends BasePageView<HomeFilePageCallback> {
  final HomeFilePageController homeFilePageController;

  const HomeFilePageView({super.key, required this.homeFilePageController, required HomeFilePageCallback pageCallback})
      : super(pageCallback: pageCallback);

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final length = homeFilePageController.videoGroupList.length;
      if (homeFilePageController.isLoading) {
        return Container(
      ...
      return VideoGroupListView(
        controller: homeFilePageController,
        videoGroupList: homeFilePageController.videoGroupList,
