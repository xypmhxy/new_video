  ...
  Future<List<MediaInfo>> requestRecommend({String? youtubeId, String? continuation}) async {
    try {
      ...
      if (continuation != null) {
        ...
        // mediaList = await YoutubeUtils.instance.analyseResult(responseJson, youtubeId: youtubeId);
      }
      // LogUtils.i("requestYoutubeVideoRecommend finished mediaList count:${mediaList.length}");
      return mediaInfos;
